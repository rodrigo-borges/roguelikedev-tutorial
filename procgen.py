...
def tunnel_between(
    ...
    for x, y in bresenham((x1, y1), (corner_x, corner_y)).tolist():
        yield x, y
    for x, y in bresenham((corner_x, corner_y), (x2, y2)).tolist():
        yield x, y
...
def generate_dungeon(
    ...
    for r in range(max_rooms):
        ...
        # RectangulerRoom class makes rectangles easier to work with
